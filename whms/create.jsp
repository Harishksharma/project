            ...
            <form role="form" method="post" action="" id="allinfo">
                ...
                <center><h1>Decoration Details</h1>
                    ...
                    <fieldset class="form-group">
                        ...
                        <label for="decoid">
                        <input type="text" class="form-control" id="oprice" name="oprice " readonly value="50 Rs/-" required></label>
                ...
                <center><h1>Catering Details</h1></center>
                    ...
                    <fieldset class="form-group">
                        ...
                        <input type="number" class="form-control" id="bfood" name="bfood" required>
                    </fieldset>
                    <br>
